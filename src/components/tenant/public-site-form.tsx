        ...
        <fieldset disabled={!canEdit} className="space-y-5 disabled:opacity-60">
          ...
          <section className="rounded-3xl border border-stone-200 bg-stone-50 p-4 sm:p-5">
            ...
            <div className="mt-4 grid gap-3 md:grid-cols-2">
              ...
              <Toggle name="acceptsReservations" label="Aceitar contato para reservas" hint="Mostra CTA de reserva/contato quando houver WhatsApp/telefone." defaultChecked={profile?.accepts_reservations ?? false} />
