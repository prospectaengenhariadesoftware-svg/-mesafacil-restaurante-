...
export default async function CadastroPage({ searchParams }: Readonly<{ searchParams?: Promise<Record<string, string | string[] | undefined>> }>) {
  ...
  return (
    <AuthCard
      ...
      footer={<><span>Já tem conta? </span><Link className="text-red-600" href="/login">Entrar</Link></>}
    >
      ...
      <form action={signUpAction} className="space-y-4">
        ...
        <p className="text-xs leading-5 text-stone-500">Use no mínimo 8 caracteres, com letras e números.</p>
